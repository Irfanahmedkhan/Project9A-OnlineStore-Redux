    ...
    <Grid container className={classes.Container}>
      ...
      <Grid item >
        <Grid item style={{height: "5vh"}}>
          <Typography component="p" style={{
            color: "white", textAlign: "left", fontWeight: 600, letterSpacing: "2px", fontFamily: "Barlow Condensed", marginTop: "20px", marginLeft: "20px", fontSize: "25px"}} > 
        ...
        <Grid item  className={classes.Main}>
          ...
          {NewArival.map((New, i) => {
            ...
            return (
              ...
              <Grid item xs={12} sm={4} md={3} key={i} className={classes.CardContainer} >
                <Link to="/Products" >
